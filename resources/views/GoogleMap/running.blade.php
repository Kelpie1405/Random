    ...
    <body>
        <div class="w-screen h-screen bg-purple-100 relative">
            ...
            <div class="absolute top-16 left-8 z-10 rounded-md border-black border-2 p-4 bg-white">
                ...
                <div class="">
                    <button type="button" id="addWaypoint" class="w-full mx-auto rounded p-2 bg-amber-400 text-white font-medium">途中地点を追加</button>
                </div>
                <div class="mt-2">
                    <button type="button" id="endpoint" class="w-full mx-auto rounded-full p-2 bg-purple-700 text-white font-medium">ゴール地点を選択</button>
                </div>
                <div id="total"></div>
            </div>
        ...
        <script src="{{ asset('js/GoogleMap/running.js') }}"></script>
        <script async
